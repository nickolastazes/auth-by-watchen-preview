			...
			{session && (
				<>
					...
					<Drawer.Root
						...
						direction='right'>
						<Drawer.Trigger className='relative flex items-center border border-[#4B5563]/40 rounded-full sm:rounded-xl space-x-2 text-sm p-0.5 sm:py-1 sm:px-1.5 font-medium bg-white/10 text-neutral-100 shadow-md'>
							<span>{renderNavUserImage()}</span>
